...
def calculate_overall_confidence(
    ...
    Formule:
        overall = (weighted_avg * 0.45) + (coverage_score * 0.25) +
                  (completeness_ratio * 0.15) + (red_flag_clarity * 0.15)
    ...
    Où:
        ...
        - completeness_ratio: Bonus si beaucoup de champs détectés vs longueur du texte
        - red_flag_clarity: Proportion de red flags explicitement détectés
    ...
    # 3. Bonus de complétude
    expected_fields = min(3 + text_length // 50, 10)
